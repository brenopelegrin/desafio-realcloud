...
export default function SpottedCard({id, user_id, text, created_at, updated_at, image, user, postVotes, comments}){
        ...
        return(
                    ...
                    >
                        ...
                        <Box 
                            ...
                            padding="0.5em"
                            borderRadius={15}
                            background={useColorModeValue('blue.300', 'blue.700')}
                        >
    ...
    return(
        <>
        <Card maxW='md' size='xm' bg={useColorModeValue('blue.200', 'blue.800')} borderRadius={15}>
        <Stack divider={<StackDivider borderColor={useColorModeValue('blackAlpha.200', 'whiteAlpha.200')} />} margin={3}>
            <Flex spacing={2}>
                <Flex flex='1' gap={3} alignItems='center' flexWrap='wrap'>
                    ...
                    <Text color={useColorModeValue('blue.600', 'blue.200')} align='left' fontSize='xs'>{dateFormatted}</Text>
                    </Box>
                </Flex>
                <Menu>
                    <MenuButton
        ...
        <Flex align="center" justify="space-between" flexDirection="row" gap={2}>
            <Button isDisabled={alreadyVoted} gap={1} onClick={(e) => handleVoteClick(id)} colorScheme="blue" size='sm' variant='ghost'>
                {voteButtonBody}
            </Button>
            <Button gap={1} onClick={(e) => handleCommentButton(e)} colorScheme="blue" size='sm' variant='ghost'>
                {commentButtonBody}
            </Button>
            <Button isDisabled colorScheme="blue" size='sm' variant='ghost' leftIcon={<Icon boxSize={4} as={BiShare} />}>
            Enviar
            </Button>
        </Flex>
        </Stack>
        ...
        {showComments ? <Card maxW='md' size='xm' bg={useColorModeValue('blue.500', 'blue.400')} borderRadius={15}>
                <Box
                    background={useColorModeValue('blue.100', 'blue.600')}
                    marginTop="2%"
                    borderRadius={15}
                >
                <Flex 
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered>
        <ModalOverlay />
        <ModalContent>
        <ModalHeader bg={useColorModeValue('blue.200', 'blue.600')}>
            <HStack>
                <Icon as={BiFlag}/>
                <Text>
                    Denunciar Spotted
          ...
          <Flex flexDirection="column" gap={4} pt={4}>
              {infoBox}
              <Box padding="0.5em" flexDirection="column" align='left' borderRadius={15} background={useColorModeValue('blue.200', 'blue.600')}>
